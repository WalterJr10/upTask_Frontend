                    ...
                    <Transition as={Fragment} enter="transition ease-out duration-100" enterFrom="transform opacity-0 scale-95"
                        ...
                        <Menu.Items
                            ...
                            {canEdit && (
                                <>
                                    <Menu.Item>
                                        <button type='button' className='block px-3 py-1 text-sm leading-6 text-gray-900 hover:cursor-pointer' onClick={() => navigate(location.pathname + `?editTask=${task._id}`)}>
                                            Editar Tarea
                                        </button>
                                    </Menu.Item>
